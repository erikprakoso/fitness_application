...
import 'package:fitness_application/pages/success_register_page.dart';

class FiveRegisterPage extends StatelessWidget {
  const FiveRegisterPage({super.key});
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    width: 289,
                    child: Image.asset('assets/images/Card-Goals-5.png'),
                  ),
                  Container(
